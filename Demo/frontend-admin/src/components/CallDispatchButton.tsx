...
export const CallDispatchButton: React.FC<CallDispatchButtonProps> = ({
  ...
  const handleDial = async (e?: React.FormEvent) => {
    ...
    try {
      // Direct call with relative fallback
      ...
      try {
        ...
        // Fallback to local relative endpoint if tunnel is offline
      ...
      if (response.ok && data.success) {
        ...
        // Transition to acknowledged on successful worker pickup simulation if Firestore is offline
        setTimeout(() => {
